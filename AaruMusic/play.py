# FILES BELONGS TO @BANNA_XD || @AARU_SUPPORT
...
from AaruMusic.helpers.queues import QUEUE, add_to_queue, get_queue
...
async def playfrom(client, m: Message):
    ...
    if len(m.command) < 2:
        ...
        if ";" in args:
            ...
            lmt = 9
        await m.delete()
        hmm = await m.reply(f"😐 {limit} Random Song From {chat}**")
        try:
